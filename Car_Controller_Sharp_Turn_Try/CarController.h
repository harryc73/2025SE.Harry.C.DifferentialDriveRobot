...
private:
  // the reason why there is pointers instead of a simple address is because you can't copy the servo object from the old class, and also you can't initialise 
